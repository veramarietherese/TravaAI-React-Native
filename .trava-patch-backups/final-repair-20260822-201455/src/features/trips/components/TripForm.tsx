...
const styles = StyleSheet.create({
  ...
  coverCard: { minHeight: 220, overflow: "hidden", borderRadius: 26, backgroundColor: "#EEF6FF", borderWidth: 1, borderColor: "#DDEBF8" },
  coverImage: { width: "100%", height: 230 },
  coverFallback: { minHeight: 220, alignItems: "center", justifyContent: "center", padding: 24 },
  coverGlyph: { color: "#7FA5DE", fontSize: 48 },
  ...
  submitButton: { flex: 2, minHeight: 50, alignItems: "center", justifyContent: "center", borderRadius: 16, backgroundColor: "#7FA5DE" },
