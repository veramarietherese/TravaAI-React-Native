...
/**
 * Existing real trip covers always win.
 * When none exists, use a destination-aware or varied generic public image.
 * This requires no API key and introduces no paid provider.
 */
