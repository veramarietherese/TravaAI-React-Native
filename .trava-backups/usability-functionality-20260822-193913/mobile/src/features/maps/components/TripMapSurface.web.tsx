...
export function TripMapSurface({ activities, selectedActivityId, onSelectActivity, height = 360 }: TripMapSurfaceProps) {
  ...
  return <View style={[styles.wrap, { height }]}>{createElement("iframe", { ref: frameRef as never, title: "TRAVA itinerary map", srcDoc: html, sandbox: "allow-scripts", style: { width: "100%", height: "100%", border: 0, display: "block", background: "#EEF6FF" } })}</View>;
}
