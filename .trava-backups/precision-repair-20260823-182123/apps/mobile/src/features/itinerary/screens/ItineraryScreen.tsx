...
import { PremiumItineraryEditor } from "../components/PremiumItineraryEditor";
...
export function ItineraryScreen() {
  ...
  const totalDays = useMemo(() => tripDayCount(trip.startDate, trip.endDate, state.activities), [trip.startDate, trip.endDate, state.activities]);
...
function ActivityModal({ value, day, onClose, onSave, onDelete }: {
  ...
  return <PremiumItineraryEditor value={value} day={day} onClose={onClose} onSave={onSave} onDelete={onDelete} />;
}
