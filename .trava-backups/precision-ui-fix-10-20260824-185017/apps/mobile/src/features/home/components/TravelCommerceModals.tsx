...
// eslint-disable-next-line react-hooks/set-state-in-effect -- agency-local expansion state must reset when a different agency opens in the same modal instance
    ...
    <ModalShell onClose={props.onClose}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Pressable accessibilityRole="button" onPress={props.onContinue} style={({ pressed }) => [styles.primaryAction, pressed && styles.pressed]}>
          <LinearGradient colors={["#74CEF3", "#8EABF7", "#F1A7C9"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.primaryGradient}>
...
// eslint-disable-next-line react-hooks/set-state-in-effect -- package-local expansion state must reset when a different package opens in the same modal instance
  ...
  return (
    <ModalShell onClose={props.onClose}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Pressable accessibilityRole="button" onPress={props.onContinue} style={({ pressed }) => [styles.primaryAction, pressed && styles.pressed]}>
          <LinearGradient colors={["#74CEF3", "#8EABF7", "#F1A7C9"]} start={{ x: 0, y: 0 }} end={{ x: 1, y: 0 }} style={styles.primaryGradient}><View style={[styles.blueButtonHighlight, { pointerEvents: "none" }]} /><Ionicons name="chatbubble-ellipses-outline" size={24} color="#FFFFFF" /><View><Text style={styles.primaryTitle}>Inquire via chat</Text><Text style={styles.primarySubtitle}>Chat with the travel agency</Text></View></LinearGradient>
        </Pressable>
