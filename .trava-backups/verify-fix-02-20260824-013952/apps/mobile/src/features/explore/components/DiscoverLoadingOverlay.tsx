...
export function DiscoverLoadingOverlay() {
  return (
    <View pointerEvents="none" style={s.overlay}>
      ...
      <View style={s.caption}><View style={s.dot} /><Text style={s.text}>Finding nearby places...</Text></View>
    </View>
  );
}
const s=StyleSheet.create({
  overlay:{...StyleSheet.absoluteFillObject,zIndex:20,alignItems:"center",justifyContent:"center",backgroundColor:"rgba(247,250,255,.64)",borderRadius:30},
  ...
  pinOne:{left:24,top:32,backgroundColor:"#63BDF8"},pinTwo:{right:25,top:15,backgroundColor:"#6698EF"},pinThree:{right:55,bottom:8,backgroundColor:"#75B59B"},
  ...
  dot:{width:7,height:7,borderRadius:4,backgroundColor:"#55AFFF"},text:{color:"#52617A",fontSize:10,fontWeight:"800"},
});
