...
const s = StyleSheet.create({
  ...
  searchArea: { zIndex: 30 }, search: { minHeight: 76, borderRadius: 23, paddingHorizontal: 24, flexDirection: "row", alignItems: "center", gap: 15, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E3E8F0", boxShadow: "0 10px 28px rgba(44,60,94,.08)" }, searchInput: { flex: 1, minWidth: 0, color: "#14203A", fontSize: 18, fontWeight: "600", outlineStyle: "none" }, mic: { width: 46, height: 46, borderRadius: 23, alignItems: "center", justifyContent: "center", backgroundColor: "#F8FAFF", borderWidth: 1, borderColor: "#E6EBF4" },
  ...
  tripChoices: { paddingVertical: 16, gap: 8 }, tripChoice: { minHeight: 38, paddingHorizontal: 12, borderRadius: 19, alignItems: "center", justifyContent: "center", backgroundColor: "#F4F6FA" }, tripChoiceOn: { backgroundColor: "#EAF1FF" }, tripChoiceText: { color: "#4F607A", fontSize: 9.5, fontWeight: "900" }, formRow: { flexDirection: "row", gap: 10, marginBottom: 14 }, formFlex: { flex: 1 }, label: { marginBottom: 6, color: "#65728A", fontSize: 9, fontWeight: "900" }, field: { height: 48, borderRadius: 16, paddingHorizontal: 13, color: "#1A2942", backgroundColor: "#F7F9FC", borderWidth: 1, borderColor: "#E2E7EF", outlineStyle: "none" }, pressed: { opacity: 0.72 },
});
