...
const s = StyleSheet.create({
  ...
  addBar: { padding: 14, borderRadius: 26, backgroundColor: "#FFFFFF", borderWidth: 1, borderColor: "#E5E8EE", gap: 11, boxShadow: "0 10px 26px rgba(40,49,67,.05)" }, input: { height: 50, borderRadius: 17, paddingHorizontal: 15, color: PX.ink, backgroundColor: "#F7F9FC", borderWidth: 1, borderColor: "#E5E8EE", outlineStyle: "none" }, categoryChooser: { gap: 7 }, categoryChip: { minHeight: 34, paddingHorizontal: 10, borderRadius: 17, justifyContent: "center", backgroundColor: "#F6F7FA" }, categoryChipOn: { backgroundColor: "#EDF3FF" }, categoryChipText: { color: "#788397", fontSize: 8.5, fontWeight: "800" }, categoryChipTextOn: { color: "#5E80C8" },
