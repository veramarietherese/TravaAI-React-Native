  ...
  return (
    <View style={styles.root}>
      ...
      <View style={styles.actions}>
        ...
        >
          <Ionicons name="notifications-outline" size={21} color="#33435F" />
        ...
        <Pressable
          ...
          style={({ pressed }) => [styles.iconButton, pressed && styles.pressed]}
        >
          <Ionicons name="chatbubble-ellipses-outline" size={21} color="#33435F" />
        </Pressable>
        ...
        <Pressable
          ...
          style={({ pressed }) => [styles.iconButton, pressed && styles.pressed]}
        >
          <Ionicons name="person-outline" size={21} color="#33435F" />
        </Pressable>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  iconButton: {
    ...
    boxShadow: "0 10px 24px rgba(63,68,109,0.10)",
  },
  badge: {
    position: "absolute",
    top: 7,
