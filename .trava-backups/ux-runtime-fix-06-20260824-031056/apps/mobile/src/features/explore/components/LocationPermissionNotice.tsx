...
const s=StyleSheet.create({
  ...
  secondaryText:{color:"#52617A",fontSize:9,fontWeight:"900"},primary:{minHeight:34,paddingHorizontal:11,borderRadius:17,alignItems:"center",justifyContent:"center",backgroundColor:"#55AFFF"},
