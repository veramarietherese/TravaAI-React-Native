...
export function ExpensesScreen() {
  ...
  const people = Math.max(1, acceptedMembers.length);
...
// eslint-disable-next-line react-hooks/set-state-in-effect -- receipt preview image is derived when the modal opens or invoice inputs change
