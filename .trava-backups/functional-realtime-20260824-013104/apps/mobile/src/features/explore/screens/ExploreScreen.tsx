  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (permission.status !== "granted") { if (mounted) { setLocationDenied(true); setUserCoords({ latitude: 10.3157, longitude: 123.8854 }); } return; }
      ...
      } catch { if (mounted) { setLocationDenied(true); setUserCoords({ latitude: 10.3157, longitude: 123.8854 }); } }
    })();
