...
const styles = StyleSheet.create({
  root: { paddingTop: 4, paddingBottom: 10, backgroundColor: "rgba(255,250,252,0.94)", borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: "rgba(210,214,229,0.72)" },
  ...
  tabWrap: { minWidth: 94, height: 44, alignItems: "center", justifyContent: "center", borderRadius: 22, borderWidth: 1, borderColor: "rgba(226,228,238,0.88)", backgroundColor: "rgba(255,255,255,0.74)" },
