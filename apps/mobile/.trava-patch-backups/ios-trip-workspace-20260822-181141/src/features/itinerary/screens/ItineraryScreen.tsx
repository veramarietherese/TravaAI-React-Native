...
export function ItineraryScreen() {
  ...
  const firstMappedActivity = activities.find((item) => item.latitude !== null && item.longitude !== null);
    ...
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      <ScrollView refreshControl={<RefreshControl refreshing={activitiesQuery.isRefetching} onRefresh={() => void activitiesQuery.refetch()} tintColor="#7257EC" />} contentContainerStyle={styles.content}>
        <View style={styles.maxWidth}>
          ...
          <WeatherPreparationCard latitude={firstMappedActivity?.latitude} longitude={firstMappedActivity?.longitude} destination={trip.destination} />
