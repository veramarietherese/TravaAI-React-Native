...
function ExpenseVisual({ expense }: { expense: LocalExpense }) {
  ...
  return <View style={s.expenseVisual}><Soft3DIcon colors={meta.colors} icon={meta.icon} foreground="#FFFFFF" size={44} tilt={meta.tilt}/></View>;
}
