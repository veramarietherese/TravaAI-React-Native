  ...
  return <SafeAreaView style={styles.safe} edges={["top"]}>
    <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" contentContainerStyle={styles.scroll}>
      <View style={styles.max}>
        ...
        </View> : <View style={styles.emptyPrompt}><Ionicons name="globe-outline" size={20} color="#71819A" /><Text style={styles.emptyPromptText}>Search any place worldwide. Selecting a result moves the map to its real coordinates.</Text></View>}
        ...
        {selected ? <View style={styles.featured}>
          ...
          <View style={styles.featuredCopy}>
            <Text style={styles.featuredTag}>✦ Selected place</Text>
