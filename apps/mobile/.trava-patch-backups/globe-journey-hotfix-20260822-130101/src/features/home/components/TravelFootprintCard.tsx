...
const STAT_ITEMS: Array<{ key: "distance" | "flights" | "countries" | "days"; icon: IoniconName; label: string }> = [
  { key: "distance", icon: "navigate-circle-outline", label: "Total Distance" },
  { key: "flights", icon: "airplane-outline", label: "Flights Taken" },
  { key: "countries", icon: "globe-outline", label: "Countries" },
  { key: "days", icon: "calendar-clear-outline", label: "Travel Days" },
];
...
function GlobeControl({
  ...
  return (
    ...
    >
      <Ionicons name={icon} size={20} color="#6248D8" />
    </Pressable>
  );
}
    ...
    <>
      ...
      >
        <View style={styles.headingRow}>
          ...
          >
            <Ionicons name="expand-outline" size={21} color="#6248D8" />
          </Pressable>
        </View>
        ...
        <View style={styles.globePanel}>
          ...
          <View style={styles.globeControls}>
            <GlobeControl label="Zoom in" icon="add-outline" onPress={() => sendCommand("zoom-in")} />
            <GlobeControl label="Zoom out" icon="remove-outline" onPress={() => sendCommand("zoom-out")} />
            <GlobeControl label="Reset globe" icon="refresh-outline" onPress={() => sendCommand("reset")} />
          </View>
        ...
        <View style={[styles.stats, compact && styles.statsCompact]}>
          {STAT_ITEMS.map((item) => (
            <View key={item.key} style={[styles.stat, compact && styles.statCompact]}>
              <Ionicons name={item.icon} size={18} color="#7357EF" />
      ...
      >
        <SafeAreaView style={styles.fullScreenSafe}>
          ...
          <View style={styles.fullScreenHeader}>
            ...
            >
              <Ionicons name="close-outline" size={24} color="#303C58" />
            </Pressable>
          </View>
