...
export function TravaTabBar({ state, navigation, insets }: any) {
  ...
  return (
    <View style={[{ pointerEvents: "box-none" }, styles.shell, { bottom: Math.max(10, Number(insets?.bottom || 0) + 5) }]}>
