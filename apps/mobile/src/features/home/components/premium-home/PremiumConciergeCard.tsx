...
export function getConciergeState(trip: HomeTripSummary | null, workspace: WorkspaceState | null): ConciergeState {
  ...
  return {
    ...
    route: "trip",
    detail: "TRAVA will continue watching your checklist, documents, and trip timing for useful next steps.",
  };
}
    ...
    <>
      <LinearGradient colors={["#FAF8FF", "#FFF7FC"]} start={{ x: 0, y: 0.3 }} end={{ x: 1, y: 0.7 }} style={styles.card}>
        <View pointerEvents="none" style={styles.iconStage}>
          <LinearGradient colors={["#EEE8FF", "#FCEBFA", "#E8F4FF"]} style={StyleSheet.absoluteFill} />
          <Image
            source={require("../../assets/premium-home/concierge-mascot.png")}
            contentFit="contain"
        ...
        <View style={styles.content}>
          ...
          <View style={styles.buttons}>
            <TravaButton tone="blue" size="compact" label={state.primaryLabel} icon="briefcase-outline" onPress={() => onPrimaryPress(state)} style={{ flex: 1 }} />
            <TravaButton tone="blue" size="compact" label="Learn more" onPress={onInfoOpen} />
          </View>
        </View>
      </LinearGradient>
      ...
      <Modal visible={infoOpen} transparent animationType="fade" onRequestClose={onInfoClose}>
        <Pressable style={styles.modalBackdrop} onPress={onInfoClose}>
          <Pressable onPress={() => undefined} style={styles.sheet}>
            ...
            <TravaButton label="Got it" tone="blue" onPress={onInfoClose} />
          </Pressable>
        </Pressable>
      </Modal>
    </>
...
const styles = StyleSheet.create({
  ...
  iconStage: {
    ...
    overflow: "hidden",
    borderWidth: 1,
    borderColor: "rgba(225,218,250,0.88)",
  },
  icon: { width: 61, height: 61 },
