...
export function CreateTripScreen() {
  ...
  useEffect(() => {
    ...
    if (q.length < 2) {
// eslint-disable-next-line react-hooks/set-state-in-effect -- short destination queries intentionally restore the curated zero-cost local suggestions
  ...
  useEffect(() => {
// eslint-disable-next-line react-hooks/set-state-in-effect -- editing the collaborator identity intentionally invalidates the previous exact user match
