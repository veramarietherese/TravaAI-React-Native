...
const s = StyleSheet.create({safe:{flex:1,backgroundColor:"#FFF"},scroll:{padding:18,paddingBottom:120},max:{width:"100%",maxWidth:760,alignSelf:"center"},top:{height:58,flexDirection:"row",alignItems:"center",justifyContent:"space-between"},circle:{width:44,height:44,borderRadius:22,alignItems:"center",justifyContent:"center",backgroundColor:"#F7F7F8",borderWidth:1,borderColor:"#E2E3E5"},topTitle:{color:"#1A1D21",fontSize:16,fontWeight:"900"},cover:{marginTop:10,height:330,borderRadius:32,overflow:"hidden",backgroundColor:"#EEE",borderWidth:1,borderColor:"#DFE0E2"},coverFallback:{flex:1,alignItems:"center",justifyContent:"center"},coverShade:{...StyleSheet.absoluteFill,backgroundColor:"rgba(13,15,18,.24)"},coverMeta:{position:"absolute",left:22,right:22,bottom:22},coverTag:{alignSelf:"flex-start",paddingHorizontal:9,paddingVertical:5,borderRadius:9,overflow:"hidden",backgroundColor:"rgba(255,255,255,.88)",color:"#33373D",fontSize:8,fontWeight:"900",letterSpacing:.7},coverTitle:{marginTop:10,color:"#FFF",fontSize:30,lineHeight:35,fontWeight:"900",letterSpacing:-.8},coverDestination:{marginTop:4,color:"rgba(255,255,255,.88)",fontSize:11,fontWeight:"700"},headRow:{marginTop:20,flexDirection:"row",gap:16,alignItems:"flex-start"},title:{color:"#15181C",fontSize:27,lineHeight:32,fontWeight:"900",letterSpacing:-.6},metaRow:{marginTop:10,flexDirection:"row",flexWrap:"wrap",gap:7},metaPill:{height:34,paddingHorizontal:10,borderRadius:17,flexDirection:"row",alignItems:"center",gap:5,backgroundColor:"#F6F6F7",borderWidth:1,borderColor:"#E2E3E5"},metaText:{color:"#5F646C",fontSize:9,fontWeight: "700"},priceBox:{alignItems:"flex-end"},price:{color:"#181B1F",fontSize:23,fontWeight:"900"},per:{marginTop:3,color:"#858A91",fontSize:8,fontWeight:"700"},description:{marginTop:16,color:"#595E66",fontSize:12,lineHeight:20,fontWeight:"600"},metrics:{marginTop:19,flexDirection:"row",gap:8},metric:{flex:1,minHeight:92,padding:11,borderRadius:20,alignItems:"center",justifyContent:"center",backgroundColor:"#F8F8F8",borderWidth:1,borderColor:"#E2E3E5"},metricTitle:{marginTop:6,color:"#272B30",fontSize:10,fontWeight:"900"},metricSub:{marginTop:2,color:"#81868E",fontSize:7,textAlign:"center",fontWeight: "600"},section:{marginTop:22},sectionTitle:{color:"#1E2227",fontSize:16,fontWeight:"900"},sectionBody:{marginTop:10,gap:9},point:{flexDirection:"row",alignItems:"flex-start",gap:9},pointText:{flex:1,color:"#555A62",fontSize:10,lineHeight:16,fontWeight: "600"},infoRow:{minHeight:47,flexDirection:"row",alignItems:"center",justifyContent:"space-between",gap:14,borderBottomWidth:StyleSheet.hairlineWidth,borderBottomColor:"#E3E4E6"},infoLabel:{color:"#858990",fontSize:9,fontWeight:"700"},infoValue:{flex:1,textAlign:"right",color:"#292D32",fontSize:10,fontWeight: "800"},agency:{marginTop:22,minHeight:84,padding:12,borderRadius:22,flexDirection:"row",alignItems:"center",gap:11,backgroundColor:"#F8F8F8",borderWidth:1,borderColor:"#E1E2E4"},agencyLogo:{width:56,height:56,borderRadius:28,overflow:"hidden",alignItems:"center",justifyContent:"center",backgroundColor:"#E9E9EA"},agencyLetter:{color:"#31353A",fontSize:20,fontWeight:"900"},agencyLabel:{color:"#8B8F96",fontSize:7,fontWeight:"900",letterSpacing:.7},agencyName:{marginTop:2,color:"#25292E",fontSize:13,fontWeight:"900"},agencySub:{marginTop:3,color:"#7B8087",fontSize:8,fontWeight: "600"},security:{marginTop:18,padding:13,borderRadius:18,flexDirection:"row",alignItems:"flex-start",gap:9,backgroundColor:"#F6F6F7",borderWidth:1,borderColor:"#E0E1E3"},securityText:{flex:1,color:"#666B72",fontSize:9,lineHeight:15,fontWeight: "600"},actions:{marginTop:18,flexDirection:"row",gap:9},secondary:{flex:1,height:52,borderRadius:17,flexDirection:"row",alignItems:"center",justifyContent:"center",gap:7,borderWidth:1,borderColor:"#D8D9DC",backgroundColor:"#FFF"},secondaryText:{color:"#292D32",fontSize:10,fontWeight:"900"},primary:{flex:1.25,height:52,borderRadius:17,flexDirection:"row",alignItems:"center",justifyContent:"center",gap:7,backgroundColor:"#25282D"},primaryText:{color:"#FFF",fontSize:10,fontWeight:"900"},center:{flex:1,alignItems:"center",justifyContent:"center",padding:28,gap:10},centerText:{maxWidth:360,textAlign:"center",color:"#777C84",fontSize:10,lineHeight:16,fontWeight: "600"},emptyIcon:{width:64,height:64,borderRadius:22,alignItems:"center",justifyContent:"center",backgroundColor:"#F2F2F3"},emptyTitle:{color:"#25292E",fontSize:20,fontWeight:"900"},darkButton:{marginTop:7,height:46,paddingHorizontal:18,borderRadius:15,alignItems:"center",justifyContent:"center",backgroundColor:"#282B30"},darkText:{color:"#FFF",fontSize:10,fontWeight:"900"}});
